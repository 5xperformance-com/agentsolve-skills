#!/usr/bin/env python3
"""Run the Stage 0 CVRP/VRPTW-lite quote -> job -> poll example."""
...
INPUT_SCHEMA_VERSION = "1.2.vrp.cvrp.input.v2"
OUTPUT_SCHEMA_VERSION = "1.2.vrp.cvrp.output.v2"
EXAMPLE_ID = "cvrp-vrptw-lite-seeded-001"
CANONICAL_PROBLEM_HASH = "d2e486eef7f4351b3556e5402eaacc64f49296226073b3b03673f9e74e38403d"
