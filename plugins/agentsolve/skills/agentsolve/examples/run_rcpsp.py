#!/usr/bin/env python3
"""Run the Stage 0 RCPSP quote -> job -> poll example."""
...
INPUT_SCHEMA_VERSION = "4.1.scheduling.rcpsp.input.v2"
OUTPUT_SCHEMA_VERSION = "4.1.scheduling.rcpsp.output.v2"
EXAMPLE_ID = "rcpsp-calendar-seeded-001"
CANONICAL_PROBLEM_HASH = "cff885ee83ad6a0502a330990ebecdbfdfd49d4b9500b622d6771fedd4793c29"
...
PAYLOAD = {
    ...
    "resources": {
        "crew": {
            "capacity": 3,
            "calendar": [
                {"start_day": 0, "end_day": 4, "capacity": 3},
                {"start_day": 4, "end_day": 7, "capacity": 3},
            ],
        },
        "crane": {
            "capacity": 1,
            "calendar": [{"start_day": 0, "end_day": 7, "capacity": 1}],
        },
    },
    "activities": [
        {
    ...
    "precedences": [
        {"predecessor": "foundation", "successor": "framing", "type": "FS", "min_lag": 0},
        {"predecessor": "framing", "successor": "inspection", "type": "FF", "min_lag": 0},
    ],
...
DRY_RESULT = {
    ...
    "objective_value": 6,
    "schedule": [
        {"activity_id": "foundation", "start_day": 0, "finish_day": 2},
        {"activity_id": "framing", "start_day": 2, "finish_day": 5},
        {"activity_id": "inspection", "start_day": 5, "finish_day": 6},
    ],
